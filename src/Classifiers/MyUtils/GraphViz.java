...
public class GraphViz {
    ...
    public static String absolutePath = GUIUtils.getAboslutePath();

    /**
     * The dir. where temporary files will be created.
     */
    private static String TEMP_DIR =absolutePath+ "\\tmpDir";
    ...
    public byte[] getGraph(String dot_source,String name, String type) {
        File dot;
        byte[] img_stream = null;
        try {
    ...
    private File writeDotSourceToFile(String str,String name) throws java.io.IOException {
        ...
        try {
            ...
            FileWriter fout = new FileWriter(temp);
            fout.write(str);
            BufferedWriter br = new BufferedWriter(new FileWriter(absolutePath+"\\"+name+".dot"));
            br.write(str);
            br.flush();
            br.close();
            fout.close();
